...
final class wp_easycart_admin_initial_setup{
	...
	public function install_demo_data( ){
		...
		// Insert Categories
		$categories = array( 
			(object) array( 'category_id' => '', 'name' => __( 'Specials', 'wp-easycart' ), 	'post_id' => '' ),
			(object) array( 'category_id' => '', 'name' => __( 'Sales', 'wp-easycart' ), 	'post_id' => '' ),
			(object) array( 'category_id' => '', 'name' => __( 'New', 'wp-easycart' ), 		'post_id' => '' )
		);
		...
		$menulevel1_items = array(
			(object) array( 'menulevel1_id' => '', 'name' => __( 'Fashion Type', 'wp-easycart' ), 'banner_image' => 'https://support.wpeasycart.com/sampledata/v4/products/banners/clothing960x300.png', 'post_id' => '' ),
			(object) array( 'menulevel1_id' => '', 'name' => __( 'Womens Pants', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' ),
			(object) array( 'menulevel1_id' => '', 'name' => __( 'Womens Coats', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' ),
			(object) array( 'menulevel1_id' => '', 'name' => __( 'Womens Shirts', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' )
		);
		...
		$menulevel2_items = array(
			(object) array( 'menulevel2_id' => '', 'menulevel1_id' => $menulevel1_items[0]->menulevel1_id, 'name' => __( 'Work Cloths', 'wp-easycart' ), 'banner_image' => 'https://support.wpeasycart.com/sampledata/v4/products/banners/fashion960x300.png', 'post_id' => '' ),
			(object) array( 'menulevel2_id' => '', 'menulevel1_id' => $menulevel1_items[0]->menulevel1_id, 'name' => __( 'Denim Group', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' ),
			(object) array( 'menulevel2_id' => '', 'menulevel1_id' => $menulevel1_items[0]->menulevel1_id, 'name' => __( 'Weekend Wear', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' )
		);
		...
		$menulevel3_items = array(
			(object) array( 'menulevel3_id' => '', 'menulevel2_id' => $menulevel2_items[0]->menulevel2_id, 'name' => __( 'T-Shirts & Short Sleeve', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' ),
			(object) array( 'menulevel3_id' => '', 'menulevel2_id' => $menulevel2_items[0]->menulevel2_id, 'name' => __( 'Long Sleeve', 'wp-easycart' ), 'banner_image' => '', 'post_id' => '' ),
		);
		...
		// Insert Options
		$options = array(
			(object) array( 'option_id' => '', 'option_name' => __( 'Womens Shirt Sizes', 'wp-easycart' ), 'option_label' => __( 'Select Shirt Size', 'wp-easycart' ), 'option_type' => 'basic-swatch', 'option_required' => 1 ),
			(object) array( 'option_id' => '', 'option_name' => __( 'Womens Shirt Color', 'wp-easycart' ), 'option_label' => __( 'Select Shirt Color', 'wp-easycart' ), 'option_type' => 'basic-swatch', 'option_required' => 1 )
		);
		...
		$option_items = array(
			(object) array( 'optionitem_id' => '', 'option_id' => $options[0]->option_id, 'optionitem_name' => __( 'X-Petite', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/xsmall.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[0]->option_id, 'optionitem_name' => __( 'Small', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/small.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[0]->option_id, 'optionitem_name' => __( 'Medium', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/medium.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[0]->option_id, 'optionitem_name' => __( 'Large', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/large.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[0]->option_id, 'optionitem_name' => __( 'X-Large', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/xlarge.jpg' ),
			
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Blue', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/blue.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Green', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/green.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Orange', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/orange.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Pink', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/pink.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Red', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/red.jpg' ),
			(object) array( 'optionitem_id' => '', 'option_id' => $options[1]->option_id, 'optionitem_name' => __( 'Yellow', 'wp-easycart' ), 'optionitem_icon' => 'https://support.wpeasycart.com/sampledata/v4/products/swatches/yellow.jpg' )
		);
		...
		// Insert Reviews
		$reviews = array( 
			(object) array( 'title' => __( 'Great', 'wp-easycart' ), 'rating' => 5 ),
			(object) array( 'title' => __( 'Pretty Good', 'wp-easycart' ), 'rating' => 4 ),
			(object) array( 'title' => __( 'Average', 'wp-easycart' ), 'rating' => 3 ),
			(object) array( 'title' => __( 'Poor', 'wp-easycart' ), 'rating' => 2 ),
			(object) array( 'title' => __( 'The Worst', 'wp-easycart' ), 'rating' => 1 )
		);
