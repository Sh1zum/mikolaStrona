...
<input type="hidden" name="menulevel1_id" value="<?php echo $this->menulevel1->menulevel1_id; ?>" />
        ...
        <div class="ec_admin_flex_row">
            <div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
                ...
                <div class="ec_admin_settings_label">
                    ...
                    <span><?php if( isset( $_GET['ec_admin_form_action'] ) && $_GET['ec_admin_form_action'] == 'add-new-menulevel1' ){ _e( 'ADD NEW MENU', 'wp-easycart' ); }else{ _e( 'EDIT MENU', 'wp-easycart' ); } ?></span>
