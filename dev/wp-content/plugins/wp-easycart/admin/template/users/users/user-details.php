    ...
    <div class="ec_admin_important_numbered_list">
        ...
        <div class="ec_admin_flex_row">
            <div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
                ...
                <div class="ec_admin_settings_label">
                    ...
                    <span><?php if( isset( $_GET['ec_admin_form_action'] ) && $_GET['ec_admin_form_action'] == 'add-new' ){ _e( 'ADD NEW USER ACCOUNT', 'wp-easycart' ); }else{ _e( 'EDIT USER ACCOUNT', 'wp-easycart' ); } ?></span>
                    <div class="ec_page_title_button_wrap">
                        ...
                        <?php if( !isset( $_GET['ec_admin_form_action'] ) || $_GET['ec_admin_form_action'] != "add-new" ){ ?>
                            <a href="admin.php?page=wp-easycart-orders&subpage=orders&filter_2=<?php echo $this->user->user_id; ?>" class="ec_page_title_button"><?php _e( 'View Orders', 'wp-easycart' ); ?></a>
                            <a href="admin.php?page=wp-easycart-users&subpage=accounts&ec_admin_form_action=user-login-override&user_id=<?php echo $this->user->user_id; ?>" class="ec_page_title_button"><?php _e( 'Login as User', 'wp-easycart' ); ?></a>
                        <?php }?>
                ...
                <div class="ec_admin_settings_input ec_admin_settings_currency_section">
                	<div id="ec_admin_row_heading_title" class="ec_admin_row_heading_title"><?php _e( 'User Account Setup', 'wp-easycart' ); ?><br></div>
                    <div id="ec_admin_row_heading_message" class="ec_admin_row_heading_message"><p><?php _e( 'EasyCart user accounts can store their billing and shipping address information as well as important shipping, tax, and user role preferences.', 'wp-easycart' ); ?></p></div>
        ...
        <div class="ec_admin_flex_row">
            <div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
                ...
                <div class="ec_admin_settings_label">
                    <div class="dashicons-before dashicons-admin-users"></div>
                    <span><?php _e( 'EDIT OPTIONAL ACCOUNT SETTINGS', 'wp-easycart' ); ?></span>
                    <div class="ec_page_title_button_wrap">
                        <a href="<?php echo $this->docs_link; ?>" target="_blank" class="ec_help_icon_link">
                            <div class="dashicons-before ec_help_icon dashicons-info"></div> <?php _e( 'Help', 'wp-easycart' ); ?>
                        </a>
                ...
                <div class="ec_admin_settings_input ec_admin_settings_currency_section">
                	<div id="ec_admin_row_heading_title" class="ec_admin_row_heading_title"><?php _e( 'Optional User Account Settings', 'wp-easycart' ); ?><br></div>
                    <div id="ec_admin_row_heading_message" class="ec_admin_row_heading_message"><p><?php _e( 'You may add various optional components to this account such as exclude them from shipping and taxes. You may also add administrative notes or VAT registration numbers depending on your needs.', 'wp-easycart' ); ?></p></div>
        ...
        <div class="ec_admin_flex_row">
            ...
            <div class="ec_admin_list_line_item ec_admin_col_6 ec_admin_col_first">
                ...
                <div class="ec_admin_settings_label">
                    <div class="dashicons-before dashicons-admin-users"></div>
                    <span><?php _e( 'EDIT BILLING ADDRESS', 'wp-easycart' ); ?></span>
                    <div class="ec_page_title_button_wrap">
                    	<a  class="ec_page_title_button" onclick="copy_to_shipping();"><?php _e( 'Copy to Shipping', 'wp-easycart' ); ?></a>
                        <a href="<?php echo $this->docs_link; ?>" target="_blank" class="ec_help_icon_link">
                            <div class="dashicons-before ec_help_icon dashicons-info"></div> <?php _e( 'Help', 'wp-easycart' ); ?>
                        </a>
                    </div>
            ...
            <div class="ec_admin_list_line_item ec_admin_col_6 ec_admin_col_last">
                ...
                <div class="ec_admin_settings_label">
                    <div class="dashicons-before dashicons-admin-users"></div>
                    <span><?php _e( 'EDIT SHIPPING ADDRESS', 'wp-easycart' ); ?></span>
                    <div class="ec_page_title_button_wrap">
                        <a href="<?php echo $this->docs_link; ?>" target="_blank" class="ec_help_icon_link">
                            <div class="dashicons-before ec_help_icon dashicons-info"></div> <?php _e( 'Help', 'wp-easycart' ); ?>
                        </a>
