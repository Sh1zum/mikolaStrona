<div class="ec_admin_manual_payment_row">
    <div class="ec_admin_slider_row">
        ...
        <h3><?php _e( 'Bill Later', 'wp-easycart' ); ?></h3>
        <div class="ec_admin_slider_row_description">
            <div><?php _e( 'This method can be considered a pay later option. Customers cannot actually pay you during the checkout process with this method, but can create an order that you can collect payment later.', 'wp-easycart' ); ?></div>
            <a href="#" onclick="return direct_deposit_show_advanced( );" id="direct_deposit_advanced_link"><?php _e( 'Advanced Options', 'wp-easycart' ); ?> &#9660;</a>
        </div>
        <div class="ec_admin_toggles_wrap">
            <div class="ec_admin_toggle">
                <span><?php _e( 'Enable', 'wp-easycart' ); ?>:</span>
        ...
        <div id="ec_direct_deposit_options" class="ec_admin_initial_hide">
            <div class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show"><?php _e( 'Payment Title', 'wp-easycart' ); ?>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show"><?php _e( 'Payment Message', 'wp-easycart' ); ?>
            ...
            <div class="ec_admin_settings_input">
                <input type="submit" class="ec_admin_settings_simple_button" onclick="return ec_admin_save_direct_deposit_options( );" value="<?php _e( 'Save Options', 'wp-easycart' ); ?>" />
            </div>
        </div>
    </div>
</div>