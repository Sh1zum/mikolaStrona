...
class ec_admin_settings{
	...
	private function process_initial_setup( ){
		...
		// Process Page Setups
		$ec_option_storepage = $this->setup_page( $_POST['ec_option_storepage'], __( "Store", 'wp-easycart' ), "[ec_store]", "[ec_store" );
		$ec_option_cartpage = $this->setup_page( $_POST['ec_option_cartpage'], __( "Cart", 'wp-easycart' ), "[ec_cart]", "[ec_cart" );
		$ec_option_accountpage = $this->setup_page( $_POST['ec_option_accountpage'], __( "Account", 'wp-easycart' ), "[ec_account]", "[ec_account" );
