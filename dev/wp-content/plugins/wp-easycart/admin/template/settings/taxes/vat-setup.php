...
<div class="ec_admin_list_line_item">
	...
	<div class="ec_admin_settings_input ec_admin_settings_products_section">
		...
		<div id="ec_admin_vat_country_rates"<?php if( !$show_vat || !$vat_by_country ){ ?> style="display:none;"<?php }?>>
			...
			<h3 style="float:left; width:100%; margin:0;"><?php _e( 'VAT Country Rates', 'wp-easycart' ); ?></h3>
            <p><?php _e( 'This feature pulls the VAT rate from the country once the user enters their country on checkout. All countries have rates, but zero rates do not show in this list. Default rate only applies before the customer provides their country in checkout.', 'wp-easycart' ); ?></p>
