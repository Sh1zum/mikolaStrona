    ...
    <table width='539' border='0' align='center' cellpadding='0' cellspacing='0'>
                    			...
                    			<tr>
                    				...
                    				<?php 
										...
										if( $this->cart->cart[$i]->is_giftcard && $this->is_approved ){
											echo "<a href=\"" . plugins_url( EC_PLUGIN_DIRECTORY . "/inc/scripts/print_giftcard.php?order_id=" . $this->order_id . "&orderdetail_id=" . $this->cart->cart[$i]->orderdetail_id . "&giftcard_id=" . $this->cart->cart[$i]->giftcard_id . ( ( $this->guest_key != "" ) ? '&ec_guest_key=' . $this->guest_key : '' ) ) . "\" target=\"_blank\">" . $GLOBALS['language']->get_text( "account_order_details", "account_orders_details_print_online" ) . "</a>";
       ...
       <?php if( ( $tax_struct->is_tax_enabled( ) && !get_option( 'ec_option_enable_easy_canada_tax' ) ) || ( get_option( 'ec_option_enable_easy_canada_tax' ) && $tax > 0 ) ){ ?>
        ...
        <tr>
            ...
            <td width='91' align='center' class='style22'><?php echo $GLOBALS['language']->get_text( "account_order_details", "account_orders_details_refund_total_short" ); ?></td>

            <td align='center' class='style22'>-<?php echo $refund; ?></td>
