...
<div class="ec_details_add_to_cart_area">
    ...
    <?php }else if( $product->login_for_pricing && !$product->is_login_for_pricing_valid( ) ){ ?>
        <div class="ec_details_add_to_cart"><a href="<?php echo $product->account_page; ?>"><?php echo ( $product->login_for_pricing_label != '' ) ? $product->login_for_pricing_label : $GLOBALS['language']->get_text( 'product_page', 'product_page_login_for_price' ); ?></a></div>
