...
<div class="ec_cart_error_row" style="display:block; line-height:1.8em; float:none; margin-bottom:20px;">
    <?php echo $GLOBALS['language']->get_text( 'ec_errors', 'ideal_processing' )?> 
</div>
<?php }?>
