    	...
    	<tbody>
    		<tr>
                ...
                <td class="ec_image">
                    ...
                    else if( $cart_item->image1_optionitem != "" && file_exists( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $cart_item->image1_optionitem ) && !is_dir( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $cart_item->image1_optionitem ) )
                        $img_url = plugins_url( "wp-easycart-data/products/pics1/" . $cart_item->image1_optionitem );

                    else if( substr( $cart_item->image1, 0, 7 ) == 'http://' || substr( $cart_item->image1, 0, 8 ) == 'https://' )
                        $img_url = $cart_item->image1;

                    else if( file_exists( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $cart_item->image1 ) && !is_dir( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $cart_item->image1 ) )
                        $img_url = plugins_url( "wp-easycart-data/products/pics1/" . $cart_item->image1 );
                    ...
                    ?>
                    <div style="ec_lineitem_image"><img src="<?php echo str_replace( "https://", "http://", $img_url ); ?>" alt="<?php echo str_replace( '"', '\"', $GLOBALS['language']->convert_text( $cart_item->title ) ); ?>" style="max-width:300px;" /></div>
                </td>
                <?php }?>
                <td class="ec_content">
                    ...
                    <div class="ec_content_row ec_extra_margin"><?php echo $GLOBALS['language']->get_text( "cart_success", "cart_giftcard_receipt_message" ); ?> <a href="<?php echo $store_page; ?>" target="_blank"><?php echo $store_page; ?></a>.</div>
                </td>
            </tr>
        </tbody>
    </table>
