...
class ec_orderdisplay{
	...
	function __construct( $order_row, $is_order_details = false, $is_admin = false ){
		...
		if( $order_row ){
			...
			$this->tip_total = $order_row->tip_total;
	...
	public function display_tip_total( ){
		echo $this->currency->get_currency_display( $this->tip_total );
	}
	...
	public function display_order_billing_first_name( ){
		echo htmlspecialchars( stripslashes( $this->billing_first_name ), ENT_QUOTES );
	}
	
	public function display_order_billing_last_name( ){
		echo htmlspecialchars( stripslashes( $this->billing_last_name ), ENT_QUOTES );
	}
	
	public function display_order_billing_address_line_1( ){
		echo htmlspecialchars( stripslashes( $this->billing_address_line_1 ), ENT_QUOTES );
	}
	
	public function display_order_billing_city( ){
		echo htmlspecialchars( stripslashes( $this->billing_city ), ENT_QUOTES );
	}
	
	public function display_order_billing_state( ){
		echo htmlspecialchars( stripslashes( $this->billing_state ), ENT_QUOTES );
	}
	
	public function display_order_billing_zip( ){
		echo htmlspecialchars( stripslashes( $this->billing_zip ), ENT_QUOTES );
	}
	
	public function display_order_billing_country( ){
		echo htmlspecialchars( stripslashes( $this->billing_country_name ), ENT_QUOTES );
	}
	
	public function display_order_billing_phone( ){
		echo htmlspecialchars( stripslashes( $this->billing_phone ), ENT_QUOTES );
	}
	
	public function display_order_shipping_first_name( ){
		echo htmlspecialchars( stripslashes( $this->shipping_first_name ), ENT_QUOTES );
	}
	
	public function display_order_shipping_last_name( ){
		echo htmlspecialchars( stripslashes( $this->shipping_last_name ), ENT_QUOTES );
	}
	
	public function display_order_shipping_address_line_1( ){
		echo htmlspecialchars( stripslashes( $this->shipping_address_line_1 ), ENT_QUOTES );
	}
	
	public function display_order_shipping_city( ){
		echo htmlspecialchars( stripslashes( $this->shipping_city ), ENT_QUOTES );
	}
	
	public function display_order_shipping_state( ){
		echo htmlspecialchars( stripslashes( $this->shipping_state ), ENT_QUOTES );
	}
	
	public function display_order_shipping_zip( ){
		echo htmlspecialchars( stripslashes( $this->shipping_zip ), ENT_QUOTES );
	}
	
	public function display_order_shipping_country( ){
		echo htmlspecialchars( stripslashes( $this->shipping_country_name ), ENT_QUOTES );
	}
	
	public function display_order_shipping_phone( ){
		echo htmlspecialchars( stripslashes( $this->shipping_phone ), ENT_QUOTES );
	}
	...
	public function send_invoice( $admin_only = false ){
		...
		ob_start();
        $is_admin = false;
        if( file_exists( WP_PLUGIN_DIR . '/wp-easycart-data/design/layout/' . get_option( 'ec_option_base_layout' ) . '/ec_cart_email_invoice.php' ) )	
			include WP_PLUGIN_DIR . '/wp-easycart-data/design/layout/' . get_option( 'ec_option_base_layout' ) . '/ec_cart_email_invoice.php';	
		else
			include WP_PLUGIN_DIR . "/" . EC_PLUGIN_DIRECTORY . '/design/layout/' . get_option( 'ec_option_latest_layout' ) . '/ec_cart_email_invoice.php';
        $message = ob_get_clean();
