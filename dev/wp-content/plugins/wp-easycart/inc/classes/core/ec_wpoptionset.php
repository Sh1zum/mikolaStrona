...
class ec_wpoptionset{
	...
	private function generate_wp_option_names_and_defaults(){
		...
		array_push($this->wp_option_names, 'ec_option_db_version_verified');				array_push($this->wp_option_defaults, '4.3.2' );
																							array_push($this->wp_option_groups, 'ec-store-db-group');
		array_push($this->wp_option_names, 'ec_option_db_version_updated');				    array_push($this->wp_option_defaults, '4.3.2' );
																							array_push($this->wp_option_groups, 'ec-store-db-group');
		...
		array_push($this->wp_option_names, 'ec_option_no_vat_on_shipping');					array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_vat_rounding');					    array_push($this->wp_option_defaults, '.01' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_collect_user_phone');					array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_user_phone_required');				array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_customer_review_show_user_name');		array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_customer_review_notification');		array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_font_main');							array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_font_custom');						array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_show_card_holder_name');				array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_enable_tips');				        array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_validate_vat_registration_number');	array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_collect_vat_registration_number_stripe_id');array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_fedex_use_net_charge');				array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_live_override_always');				array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_enable_recaptcha');					array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_enable_recaptcha_cart');				array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_tempcart_stock_timeframe');			array_push($this->wp_option_defaults, 'HOUR' );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		array_push($this->wp_option_names, 'ec_option_enable_inventory_notification');		array_push($this->wp_option_defaults, 0 );
																							array_push($this->wp_option_groups, 'ec-store-setup-group');
		...
		array_push($this->wp_option_names, 'ec_option_payment_third_party');				array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cashfree_app_id');			        array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cashfree_secret');			        array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cashfree_currency');			        array_push($this->wp_option_defaults, 'USD' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cashfree_testmode');			        array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		...
		array_push($this->wp_option_names, 'ec_option_paypoint_merchant_id');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_paypoint_vpn_password');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		...
		array_push($this->wp_option_names, 'ec_option_chronopay_shared_secret');			array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_site');				    array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_merch');				    array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_username');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_password');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_shipfromzip');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_cardpointe_currency');				array_push($this->wp_option_defaults, 'USD' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		...
		array_push($this->wp_option_names, 'ec_option_square_access_token');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_refresh_token');				array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		...
		array_push($this->wp_option_names, 'ec_option_square_location_country');			array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_merchant_name');			    array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_is_sandbox');			        array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_sandbox_location_id');			array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_sandbox_access_token');        array_push($this->wp_option_defaults, '' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_square_digital_wallet');              array_push($this->wp_option_defaults, '0' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		...
		array_push($this->wp_option_names, 'ec_option_stripe_currency');					array_push($this->wp_option_defaults, 'USD' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_stripe_company_country');				array_push($this->wp_option_defaults, 'US' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
		array_push($this->wp_option_names, 'ec_option_stripe_enable_apple_pay');			array_push($this->wp_option_defaults, '1' );
																							array_push($this->wp_option_groups, 'ec-payment-group');
