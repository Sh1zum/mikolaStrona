...
class ec_productwidget extends WP_Widget{
	...
	function form($instance){
		...
		echo "<p><label for=\"" . $this->get_field_name( 'model_number' ) . "\">" . _e( 'Product (enter SKU):' ) . "</label><input type=\"text\" class=\"widefat\" id=\"" . $this->get_field_id( 'model_number' ) . "\" name=\"" . $this->get_field_name( 'model_number' ) . "\" value=\"" . esc_attr( $model_number ) . "\" />";
