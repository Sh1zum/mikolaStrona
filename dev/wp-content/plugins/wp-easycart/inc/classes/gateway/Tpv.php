...
class Tpv{
    ...
    {
        $form='
		<form action="'.$this->_setEnviroment.'" method="post" id="ec_redsys_standard_auto_form" name="ec_redsys_standard_auto_form" >
			...
			<div class="ec_third_party_submit_button">
				<input type="submit" value="' . $GLOBALS['language']->get_text( "cart_payment_information", "cart_payment_information_third_party" ) . ' Redsys" id="ec_third_party_submit_payment" />
			</div>
		</form>
        ';
